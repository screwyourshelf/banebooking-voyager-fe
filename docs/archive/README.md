...
Dokumentene i denne mappen er historiske implementeringsplaner, analyser eller fullførte
refaktorgrunnlag. De beholdes foreløpig for sporbarhet og kan vurderes slettet i en senere
opprydding.

Arkiverte dokumenter er **ikke autoritative** for nytt arbeid. Kontroller alltid dagens
kode og aktive dokumenter i `docs/` før gamle instrukser brukes.
