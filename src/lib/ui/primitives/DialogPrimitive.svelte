<script lang="ts" module>
  ...
  export type DialogPrimitivePlacement = "bottom" | "center";
...
<script lang="ts">
  ...
  type Props = BaseProps &
    (
      | { placement?: DialogPrimitivePlacement; size: "standard" }
      | { placement?: never; size: "editor" }
    );
  ...
  <Dialog.Portal>
    ...
    <Dialog.Content
      class={[
        ...
        size === "standard" && placement === "center"
          ...
          : size === "standard"
            ? "top-auto bottom-0 left-1/2 w-navigation-overlay-more max-h-navigation-overlay-more translate-x-dialog-surface-translate-x translate-y-0 border-x border-t border-b-0 border-dialog-border rounded-navigation-overlay-more pb-navigation-safe"
      ...
      data-size={size}
      data-placement={size === "standard" ? placement : undefined}
