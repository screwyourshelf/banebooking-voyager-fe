        ...
        <RowPanel>
          <RowList>
            ...
            <Row
              ...
              right={<Switch checked={visSlettede} onCheckedChange={setVisSlettede} />}
            />
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Field>
                  <Input
                    ...
                    onChange={(e) => setEdit((s) => ({ ...s, visningsnavn: e.target.value }))}
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  value={edit.rolle}
                  onChange={(e) => setEdit((s) => ({ ...s, rolle: e.target.value as RolleType }))}
                >
